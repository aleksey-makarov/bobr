...
1. [TERM_MODEL.md](./TERM_MODEL.md)  
   Start here for the high-level execution model. It explains the core architecture: Nickel defines pure builder terms, and Rust interprets one selected evaluated build request recursively.

2. [NICKEL_API.md](./NICKEL_API.md)  
   Read this next for the intended user-facing Nickel abstraction layer: objects, builder operations, bundles, package sets, and the boundary between Nickel terms and runtime internals.
